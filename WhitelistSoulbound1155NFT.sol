...
contract WhitelistSoulbound1155NFT is Context, ERC165, IERC1155, IERC1155Errors, Ownable, ERC1155Holder {
    ...
    function uri(uint256 tokenId) public view virtual returns (string memory) {
        ...
        return bytes(tokenURI).length > 0 ? string.concat(_baseURI, tokenURI) : '';
    }
    ...
    function _safeTransferFrom(address from, address to, uint256 id, uint256 amount, bytes memory data) internal {
        ...
        _updateAmounts(from, to, ids, amounts, data);
    }
    ...
    function _mint(address to, uint256 id, uint256 amount, bytes memory data) internal {
        ...
        (uint256[] memory ids, uint256[] memory amounts) = _asSingletonArrays(id, amount);
        _updateAmounts(address(0), to, ids, amounts, data);
    }
    ...
    function _burn(address from, uint256 id, uint256 amount) internal {
        ...
        (uint256[] memory ids, uint256[] memory amounts) = _asSingletonArrays(id, amount);
        _updateAmounts(from, address(0), ids, amounts, "");
    }
